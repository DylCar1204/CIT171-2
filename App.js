...
const App = () => {
  ...
  useEffect(() => {
    ...
    const getSessionToken = async () => {
      const sessionToken = await AsyncStorage.getItem("sessionToken"); //await AsyncStorage.getItem("sessionToken");
...
const styles = StyleSheet.create({
  ...
  title: {
    textAlign: "center",
    marginTop: 20,
    paddingTop: 20, //I added this so I could see on my phone
    fontSize: 19,
    color: "#A0CE4E",
    fontWeight: "bold",
  },
