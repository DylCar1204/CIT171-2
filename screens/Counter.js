...
export default function Counter(props) {
  ...
  useEffect(() => {
    //gets username and token from storage
      ...
      <View style={styles.screen}>
        ...
        >
          ...
          <CardContent>
            ...
            <TouchableOpacity onPress={myCustomerShare} style={styles.sButton}>
              <Text title="Share">Share with Spotter</Text>
            </TouchableOpacity>
            {/* <Button
